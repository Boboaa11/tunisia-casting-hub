      ...
      <div className="min-h-screen bg-gradient-card flex items-center justify-center py-12 px-4">
        <div className="max-w-lg w-full space-y-8 animate-fade-in">
          ...
          <div className="text-center">
            ...
            <h1 className="text-3xl font-bold text-foreground">Join Tunisia Casting</h1>
            <p className="text-muted-foreground mt-2">
              Create your account and start your entertainment career
            </p>
          </div>
          ...
          <Card className="shadow-elegant bg-card">
            ...
            <CardContent>
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="space-y-2">
                  <Label htmlFor="talentType" className="text-foreground">I am a...</Label>
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    <Label htmlFor="agreeToMarketing" className="text-sm text-muted-foreground">
                      I'd like to receive updates about new casting opportunities
                    </Label>
                  </div>
                </div>
