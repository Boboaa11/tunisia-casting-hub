...
import { Camera, Search, CreditCard, Eye, ChevronRight, PartyPopper } from "lucide-react";
                  ...
                  {[
                    {
                      ...
                      description:
                        "Explorez tous les rôles disponibles gratuitement. Films, séries, publicités — tout est accessible.",
                    },
                    {
                      icon: CreditCard,
                      title: "Abonnez-vous pour postuler",
                      description:
                        "Souscrivez à un abonnement pour débloquer les candidatures et postuler aux castings qui vous intéressent.",
                    },
                    {
                      icon: Eye,
                      title: "Soyez découvert",
                      description:
                        "Les directeurs de casting peuvent parcourir votre profil et vous contacter directement.",
                    },
                  ].map((card, i) => (
                    <div
                      key={i}
